...
#define configCOMMAND_INTERPRETER_STACK_SIZE		(1000)//( configMINIMAL_STACK_SIZE * 8 )
...
#define configTOTAL_HEAP_SIZE			( ( size_t ) ( 16 * 1024 ) ) /* Has no effect in this demo as the heap is manually set to AHB RAM. */
