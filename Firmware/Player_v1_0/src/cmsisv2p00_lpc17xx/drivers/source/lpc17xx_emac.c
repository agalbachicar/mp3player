...
static void rx_descr_init (void)
{
	...
	uint32_t i;
	extern void *networkGetEMACRxBufferAddress( void );
	xEMACRxBuffer_t *rx_buf;

	rx_buf = ( xEMACRxBuffer_t * ) networkGetEMACRxBufferAddress();
...
static void tx_descr_init (void) {
	...
	uint32_t i;
	extern void *networkGetEMACTxBufferAddress( void );
	xEMACTxBuffer_t *tx_buf;

	tx_buf = ( xEMACTxBuffer_t * ) networkGetEMACTxBufferAddress();
